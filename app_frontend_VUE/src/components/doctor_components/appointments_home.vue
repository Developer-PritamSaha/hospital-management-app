...
async function loadStats() {
    try {
        const response = await axios_instance.get("/api/dashboard/doctor/week-stats")
       
        data.value.appointment_count = response.data?.appointment_count
        data.value.completed_count = response.data?.completed_count
        data.value.canceled_count = response.data?.canceled_count
                    ...
                    <div class="col-md-4">
                        <div class="card card-stat h-100 shadow-sm border-0">
                            <div class="card-body d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <h6 class="fw-bold mb-0" style="color: #4b57d1;">Upcoming Appointments</h6>
                    ...
                    <div class="col-md-4">
                        <div class="card card-stat h-100 shadow-sm border-0">
                            <div class="card-body d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <h6 class="fw-bold mb-0" style="color: #157508;">Completed Appointments</h6>
                                    <span class="h4 fw-bold mb-0 highlight-text">{{ data.completed_count }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card card-stat h-100 shadow-sm border-0">
                            <div class="card-body d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <h6 class="fw-bold mb-0" style="color: #ca890f;">Canceled Appointments</h6>
                                    <span class="h4 fw-bold mb-0 highlight-text">{{ data.canceled_count }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
