<script setup>
    ...
    async function get_user_data(){
        try{
            ...
            if(response.data.role !== 'patient' || response.data.is_active === false){
                logout()
            }
            pat_name.value = response.data?.full_name
    ...
    async function loadNotifications() {
        ...
        try {
            const response = await axios_instance.get("/api/dashboard/patient/notifications")
    ...
    async function deleteNotification(nf_id) {
        try {
            const response = await axios_instance.delete("/api/dashboard/patient/notifications", 
                {
                    params: {
